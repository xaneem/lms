...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicationLog.notes'
        db.add_column(u'leave_applicationlog', 'notes',
                      self.gf('django.db.models.fields.TextField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ApplicationLog.activity'
        db.alter_column(u'leave_applicationlog', 'activity', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ApplicationLog.notes'
        db.delete_column(u'leave_applicationlog', 'notes')


        # Changing field 'ApplicationLog.activity'
        db.alter_column(u'leave_applicationlog', 'activity', self.gf('django.db.models.fields.TextField')(max_length=50, null=True))
