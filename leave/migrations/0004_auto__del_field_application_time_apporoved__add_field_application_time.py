...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Application.time_apporoved'
        db.delete_column(u'leave_application', 'time_apporoved')

        # Adding field 'Application.time_approved'
        db.add_column(u'leave_application', 'time_approved',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CancelRequest.time_apporoved'
        db.delete_column(u'leave_cancelrequest', 'time_apporoved')

        # Adding field 'CancelRequest.time_approved'
        db.add_column(u'leave_cancelrequest', 'time_approved',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Application.time_apporoved'
        db.add_column(u'leave_application', 'time_apporoved',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Application.time_approved'
        db.delete_column(u'leave_application', 'time_approved')

        # Adding field 'CancelRequest.time_apporoved'
        db.add_column(u'leave_cancelrequest', 'time_apporoved',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CancelRequest.time_approved'
        db.delete_column(u'leave_cancelrequest', 'time_approved')
