...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Employee', fields ['code']
        db.create_unique(u'leave_employee', ['code'])


    def backwards(self, orm):
        # Removing unique constraint on 'Employee', fields ['code']
        db.delete_unique(u'leave_employee', ['code'])
