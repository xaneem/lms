...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.attachment2'
        db.add_column(u'leave_application', 'attachment2',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Application.attachment3'
        db.add_column(u'leave_application', 'attachment3',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.attachment2'
        db.delete_column(u'leave_application', 'attachment2')

        # Deleting field 'Application.attachment3'
        db.delete_column(u'leave_application', 'attachment3')
    ...
    models = {
        ...
        u'leave.application': {
            ...
            'attachment1': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
            'attachment2': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
            'attachment3': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
