...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.new_date_to'
        db.add_column(u'leave_application', 'new_date_to',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Application.new_date_from'
        db.add_column(u'leave_application', 'new_date_from',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.new_date_to'
        db.delete_column(u'leave_application', 'new_date_to')

        # Deleting field 'Application.new_date_from'
        db.delete_column(u'leave_application', 'new_date_from')
