...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Application.response'
        db.alter_column(u'leave_application', 'response', self.gf('django.db.models.fields.TextField')(max_length=400, null=True))

    def backwards(self, orm):

        # Changing field 'Application.response'
        db.alter_column(u'leave_application', 'response', self.gf('django.db.models.fields.TextField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'leave.application': {
            ...
            'response': ('django.db.models.fields.TextField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
