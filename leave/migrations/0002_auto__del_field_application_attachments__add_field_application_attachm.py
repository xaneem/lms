...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Application.attachments'
        db.delete_column(u'leave_application', 'attachments')

        # Adding field 'Application.attachment1'
        db.add_column(u'leave_application', 'attachment1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Application.attachments'
        db.add_column(u'leave_application', 'attachments',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'Application.attachment1'
        db.delete_column(u'leave_application', 'attachment1')
