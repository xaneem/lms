...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'leave_transactionlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['leave.Employee'])),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['leave.Application'], null=True)),
            ('is_admin', self.gf('django.db.models.fields.BooleanField')()),
            ('earned_balance', self.gf('django.db.models.fields.IntegerField')()),
            ('earned_change', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('hp_balance', self.gf('django.db.models.fields.IntegerField')()),
            ('hp_change', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('note', self.gf('django.db.models.fields.TextField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'leave', ['TransactionLog'])

        # Deleting field 'Application.current_position'
        db.delete_column(u'leave_application', 'current_position')

        # Adding field 'Application.is_new'
        db.add_column(u'leave_application', 'is_new',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Application.original'
        db.add_column(u'leave_application', 'original',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['leave.Application'], null=True),
                      keep_default=False)

        # Deleting field 'Employee.leave_balance'
        db.delete_column(u'leave_employee', 'leave_balance')

        # Adding field 'Employee.earned_balance'
        db.add_column(u'leave_employee', 'earned_balance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Employee.hp_balance'
        db.add_column(u'leave_employee', 'hp_balance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Employee.is_active'
        db.add_column(u'leave_employee', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'leave_cancelrequest', (
            ...
            ('time_approved', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.delete_table(u'leave_transactionlog')

        # Adding field 'Application.current_position'
        db.add_column(u'leave_application', 'current_position',
                      self.gf('django.db.models.fields.IntegerField')(default=3),
                      keep_default=False)

        # Deleting field 'Application.is_new'
        db.delete_column(u'leave_application', 'is_new')

        # Deleting field 'Application.original'
        db.delete_column(u'leave_application', 'original_id')

        # Adding field 'Employee.leave_balance'
        db.add_column(u'leave_employee', 'leave_balance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Employee.earned_balance'
        db.delete_column(u'leave_employee', 'earned_balance')

        # Deleting field 'Employee.hp_balance'
        db.delete_column(u'leave_employee', 'hp_balance')

        # Deleting field 'Employee.is_active'
        db.delete_column(u'leave_employee', 'is_active')
